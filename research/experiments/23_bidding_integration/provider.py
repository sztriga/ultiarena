...
class NetProvider:
    def __init__(self, weights_dir=_HERE, calibrate=False, betli_real_dir=None):
        self.heads = {}
        self.calib = {}
...
if __name__ == "__main__":
    sys.path.insert(0, "/Users/milansimity/Cuccok/kodok/oldtawer/experiments/14_minigame_bid_eval")
