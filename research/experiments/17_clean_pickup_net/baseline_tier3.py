"""Run tier 3 auction (exp 17 net) and produce same per-contract table
   as experiments/16_pre_pickup/baseline_auction_v2.py."""
...
from tier3_auction import simulate
...
def main():
    ...
    print()
    print(f"=== Exp 17 calibrated auction (N={N}, def=god, sol=PIMC32) ===")
    ...
    by_pc = {}
    for r in rows:
        if r['winner_pid'] is None: continue
