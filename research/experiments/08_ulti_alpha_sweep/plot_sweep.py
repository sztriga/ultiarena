...
ax1.set_xlabel("α (soloist hand bias toward strong cards)")
...
ax2.set_xlabel("α (soloist hand bias toward strong cards)")
ax2.set_ylabel("solve time (ms)")
ax2.set_title("Fast solver timing vs α")
ax2.grid(True, alpha=0.3)
ax2.legend(loc="upper right")

fig.suptitle("Ulti fast solver — α sweep", fontsize=13)
fig.tight_layout()
